...
INSERT INTO rules (domain,key,value,source) VALUES
 ...
 ('stack','media_models','Veo 3.0 is what actually serves today; 3.1 preview 404s on many projects, so ladder 3.1 -> 3.0 and REPORT which model served. Omni Flash = silent video only, and uses the v1beta1 interactions endpoint, NOT predictLongRunning - probing it the Veo way 404s and looks like "model missing"','core'),
